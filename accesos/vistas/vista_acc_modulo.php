...
<body>
    <div class="container">
        <h1 class="text-center">Modulos Aplicacion</h1>
        ...
        <form method="GET" action="../controladores/controlador_acc_modulo.php" class="form-inline mb-3">
        ...
        <table class="table table-striped table-sm mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-warning icon-edit" data-toggle="modal" data-target="#modalActualizar" data-idActualizar="<?php echo $registro['id_modulo']; ?>"
        ...
        <div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Actualizar Modulo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <script>
            function eliminar(id) {
                if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                    $.ajax({
                        type: 'POST',
                        url: '../controladores/controlador_acc_modulo.php?action=eliminar', // Cambia esto a la ruta correcta
                        data: { id: id },
        ...
        <script>
            $(document).ready(function() {
                $('#formCrear').on('submit', function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../controladores/controlador_acc_modulo.php?action=crear', // Cambia esto a la ruta correcta
                        data: $(this).serialize(),
                        success: function(response) {
                ...
                $('#formActualizar').on('submit', function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../controladores/controlador_acc_modulo.php?action=actualizar', // Cambia esto a la ruta correcta
                        data: $(this).serialize(),
                        success: function(response) {
                            location.reload(); // Recargar la página para ver los cambios
                        },
                ...
                modal.find('#nombre_modulo').val(button.data('nombre_modulo'));
