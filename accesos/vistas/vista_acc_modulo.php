...
$sort = $_GET['sort'] ?? 'orden, nombre_modulo';
$dir = $_GET['dir'] ?? 'ASC';
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                <thead>
                                    <tr>
                                        <th class="ps-3">
                                            <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'id_modulo', 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                                ID <?php if ($sort === 'id_modulo'): ?><i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i><?php endif; ?>
                                            </a>
                                        </th>
                                        <th>
                                            <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'nombre_modulo', 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                                Módulo <?php if ($sort === 'nombre_modulo'): ?><i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i><?php endif; ?>
                                            </a>
                                        </th>
                                        <th class="text-center">Icono</th>
                                        <th class="text-center">
                                            <a href="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'orden', 'dir' => $nextDir])); ?>" class="text-decoration-none text-muted">
                                                Orden <?php if ($sort === 'orden' || $sort === 'orden, nombre_modulo'): ?><i class="icon-<?php echo ($dir === 'ASC') ? 'up-dir' : 'down-dir'; ?> ms-1"></i><?php endif; ?>
                                            </a>
                                        </th>
                                        <th>
