...
<body>
    <div class="container">
        ...
        <form method="GET" action="../controladores/controlador_acc_programa.php" class="d-flex mb-3">
        ...
        <table class="table table-striped table-sm mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning icon-edit" data-bs-toggle="modal" data-bs-target="#modalActualizar" data-idActualizar="<?php echo $registro['id_programas']; ?>"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalCrearLabel">Crear Acc_programa</h5>
                    ...
                    <div class="modal-body">
                        <form id="formCrear" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="id_modulo" class="form-label">Modulo</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('modalActualizar').addEventListener('show.bs.modal', function(event) {
                ...
                if(modal.querySelector('#id_programas')) {
                    modal.querySelector('#id_programas').value = valorid_programas;
                }
                // Cargar nombre_menu
                var valornombre_menu = button.getAttribute('data-nombre_menu');
                if(modal.querySelector('#nombre_menu')) {
                    modal.querySelector('#nombre_menu').value = valornombre_menu;
                }
                // Cargar icono
                ...
                if(modal.querySelector('#ruta')) {
                    modal.querySelector('#ruta').value = valorruta;
                }
                // Cargar nombre_archivo
                var valornombre_archivo = button.getAttribute('data-nombre_archivo');
                if(modal.querySelector('#nombre_archivo')) {
                    modal.querySelector('#nombre_archivo').value = valornombre_archivo;
                }
                // Cargar orden
